...
- Si cambia una decisión, se actualiza el log (append-only en decisions).
- Fecha de última revisión al final de cada archivo.
- Cambios grandes se hacen por PR con review.
